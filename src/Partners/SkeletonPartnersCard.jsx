        ...
        <div className="users-table-page__panel">
          ...
          <div className="users-table-page__tableWrap">
            <div className="users-table-page__tableShell">
              <div className="grid grid-cols-[1.1fr_1.4fr_.45fr_.7fr] gap-4 border-b border-[#e2e8f4] px-5 py-4 max-lg:hidden">
                {['partner', 'summary', 'record', 'action'].map((key) => (
              ...
              {rowItems.map((item) => (
                <div
                  key={item}
                  className="grid grid-cols-1 gap-4 border-b border-[#edf2fa] px-5 py-5 lg:grid-cols-[1.1fr_1.4fr_.45fr_.7fr]"
                >
...
export default SkeletonPartnersCard;
