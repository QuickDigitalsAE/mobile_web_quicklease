...
const DepartmentsModel = ({ data, modelStatus, modelStatusUpdate }) => {
  ...
  return (
    <>
      ...
      <div className={`DepartmentsModel  transition-all duration-300 w-[60%]  fixed z-20  left-0 right-0 mx-auto transform translate-y-[-50%]`}>
        ...
        <div className='relative flex'>
          <div className=' bg-white rounded-xl w-full  mx-auto relative'>
            <div className='max-h-[80vh] overflow-auto modelBox'>
              <Formik initialValues={initialValues}
                ...
                <Form name="myForm">
                  <div className="DepartmentsBox p-5 px-12 rounded-xl">
                    ...
                    <div className='form mt-7'>
                      ...
                      {/* <FormControl name="discription" placeholder="Enter discription" className="outline-none w-full h-[12rem] border border-[#CFD5E2] px-5 py-3 resize-none rounded-2xl " control="textarea" /> */}
          ...
          <div className='bg-[#D4DEF1] w-0 overflow-hidden  transition-all duration-700  self-stretch rounded-xl' style={{ width: addLowyerStatus ? "30%" : "0" }}>
           {addLowyerStatus && <div className='px-3 h-full  py-4'>
              <div className="h4 text-[1.1rem] font-MluvkaBold mb-4">Lawyers</div>
                  ...
                  return (
                    ...
                    <div className="lawyerCard_ flex items-center gap-4">
                      ...
                      <div className="lawyerCard__txt" >
                        <div className="h2 text-[.7rem] font-Mluvka leading-[1]">{label}</div>
                        <p className='leading-[1] mt-1 text-primary text-[.6rem]'>{discription}</p>
                      </div>
                    </div>
                  </li>
                  )
