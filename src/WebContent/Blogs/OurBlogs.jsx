...
const OurBlogs = ({permission}) => {
    ...
    useEffect(() => {
        if (mainLanguage) {
            apiMethodGet(`webContents/metadata/blogs/${mainLanguage}`);
        }
    }, [mainLanguage]);
    ...
    const handleSubmit = (values) => {
        ...
        if (checkerRequried.length > 0) {
            ...
            apiMethod(`webContents/metadata/blogs/${mainLanguage}`, formdata)
        }
    }
    }
        ...
        <section className='Testimonials'>
            <Formik initialValues={initialValues} onSubmit={handleSubmit}  >
              ...
              <div>
                ...
                <OneImageUpload changeImage={setImageLoader} MainImage={datas?.banner} Update={setDatas} sec_value={"banner_value"} sec_image={"banner"} folder_name={"web_content_images"} page_type={"blog"} />
