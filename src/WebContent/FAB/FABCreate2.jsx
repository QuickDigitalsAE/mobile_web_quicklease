...
import SkeletonCreateEdit from '../HSBC/SkeletonCreateEdit';
...
const FABCreate2 = () => {
    ...
    if (resget.isLoading) return <SkeletonCreateEdit heading={"Edit FAB"} />
    ...
    return (
        <section className='EditPartners  pr-10 max-lg:pr-6'>
            <Link to={"/webcontent"} className="back flex items-center mb-6 gap-2">
                ...
                <span className='text-[1.4rem] font-MluvkaBold'>Edit FAB</span>
            </Link>
