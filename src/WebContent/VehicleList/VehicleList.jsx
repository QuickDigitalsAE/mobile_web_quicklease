...
import SkeletonVehicleList from './SkeletonVehicleList'
import FormControl from '../../components/form/FormControl'

const VehicleList = ({permission}) => {
        const [imageLoader, setImageLoader] = useState(false)
    const [resget, apiMethodGet] = useGet()
    const { mainLanguage } = useContext(MainLanguageContext);
    useEffect(() => {
        apiMethodGet(`webContents/metadata/vehicle-listing/${mainLanguage}`)
    }, [mainLanguage]);
    ...
    const handleSubmit = async (values) => {
        if (imageLoader) {
            ...
            apiMethod(`webContents/metadata/vehicle-listing/${mainLanguage}`, formdata)
        }
    ...
    if (resget.isLoading || !datas) return <SkeletonVehicleList />
