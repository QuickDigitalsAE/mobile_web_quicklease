...
import SkeletonFinalize from './SkeletonFinalize'
...
const Finalize = ({permission}) => {
    ...
    useEffect(() => {
        apiMethodGet(`webContents/metadata/finalize/${mainLanguage}`)
    }, [mainLanguage]);
    ...
    const handleSubmit = async (values) => {
        if (imageLoader) {
            ...
            apiMethod(`webContents/metadata/finalize/${mainLanguage}`, formdata)
        }
    ...
    if (resget.isLoading || !datas) return <SkeletonFinalize />
