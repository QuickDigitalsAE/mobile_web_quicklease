...
const PromotionCreate = ({ permission }) => {
    ...
    const { loading: loading, data: data } = useFetch(`products/allCars/en/0/1`);
    useEffect(() => {
        if (data) {
            let list = [];
    ...
    let initialValues = {
        promotion_slug: "",
        meta_title: "",
        schedule_date: dayjs().format("YYYY-MM-DDTHH:mm"),
        meta_description: "",
        promotion_title: "",
        promotion_heading: "",
        promotion_status: ["1"],
    ...
    const requireFeild = ["promotion_slug", "meta_title", "meta_description", "promotion_title ", "promotion_heading", "promotion_paragraph", "promotion_status", "schedule_date"];
    const handleSubmit = async (values) => {
        if (imageLoader) {
            ...
            if (checkerRequried.length > 0) {
                ...
                apiMethod(`promotions/create/${mainLanguage}`, formdata)
            }
        }
    ...
    return (
        <section className='PromotionCreate product-create-page'>
            <div className="product-create-page__hero">
                ...
                <p>Set up promotional content in the same compact, modern layout used across the refreshed admin forms.</p>
            </div>
                                ...
                                <div className="">
                                    ...
                                    <div className="overflow-hidden relative pt-7 px-4">
                                        <label className="inline-flex items-center cursor-pointer">
                                            <Field value="1" type="checkbox" name="promotion_status" className="sr-only peer" />
                                            ...
                                            <span className="ms-3 text-sm font-medium text-gray-900">Promotion Status</span>
                                        </label>
                                    </div>
