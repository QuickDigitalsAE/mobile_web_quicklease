      ...
      <section className="Promotions users-table-page roles-table-page">
        <div className="TeamPageTop users-table-page__top bg-white rounded-3xl p-4 enquiries-table-page__top flex justify-between items-center gap-4">
          ...
          <div className="flex w-full justify-end items-center gap-3">
            ...
            <Skeleton height={44} width={152} borderRadius={999} />
          </div>
        </div>
        ...
        <div className="users-table-page__panel">
          ...
          <div className="users-table-page__tableWrap">
            <div className="users-table-page__tableShell">
              <div className="grid grid-cols-[1.1fr_1.25fr_.72fr_.45fr_.7fr] gap-4 border-b border-[#e2e8f4] px-5 py-4 max-lg:hidden">
                {['promotion', 'summary', 'schedule', 'record', 'action'].map((key) => (
              ...
              {rowItems.map((item) => (
                <div
                  key={item}
                  className="grid grid-cols-1 gap-4 border-b border-[#edf2fa] px-5 py-5 lg:grid-cols-[1.1fr_1.25fr_.72fr_.45fr_.7fr]"
                >
                  ...
                  <Skeleton height={30} width={108} borderRadius={999} />
...
export default SkeletonPromotionsCard;
