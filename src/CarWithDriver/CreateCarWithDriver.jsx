                    ...
                    <Formik initialValues={initialValues} onSubmit={handleSubmit}>
                        <Form name="myForm">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <select value={datas?.type} onChange={(e) => handletype(e.target.value, "type")} name="type" className="outline-none w-full h-[3rem] px-5 rounded-xl"  >
                                            ...
                                            <option value={"car_with_driver"}>Car With Driver</option>
                                        </select>
                                    </div>
                                    <div>
                                        <div className="h4 text-[#7D8CA7] text-[.8rem] mb-1">
                            ...
                            <div className="bg-[#EFF4FD] p-6 rounded-3xl mb-3">
                                ...
                                <OneImageUpload changeImage={setImageLoader} MainImage={datas?.banner_image} Update={setDatas} sec_value={"banner_image_value"} sec_image={"banner_image"} folder_name={"catalog_banner_image"} page_type={"catalog"} />
...
export default CreateCarWithDriver;
